    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                ...
                # ---------------------------------------------------------
                try:
                    subject = "Deposit Request Received – Veylentra Group"
    ...
    try:
        ...
        try:
            ...
            html_content = f"""
                ...
                <br>
                <p>Best regards,<br>StableLink Capital Team</p>
            """
...
def deposit_success(request):
    ...
    # Find the wallet without requiring wallet_address to be unique.
    wallet = (
        Wallet.objects
